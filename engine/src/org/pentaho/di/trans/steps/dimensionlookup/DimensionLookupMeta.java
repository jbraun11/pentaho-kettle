...
public class DimensionLookupMeta extends BaseStepMeta implements StepMetaInterface
{
	...
	public final static int 	TYPE_UPDATE_DATE_SOURCE			= 7;
	public final static boolean IGNORE_NULLS = false;
	...
	public final static String ignoreCodes[] = {
		"Y",
		"N"
	};
    ...
    /** Should we ignore nulls when comparing fields for insert, update, punch-through */
    private boolean 			fieldIgnoreNulls[];
    ...
    /**
     * @return Returns the ignoreNulls
     */
    public boolean[] getFieldIgnoreNulls()
    {
    	return fieldIgnoreNulls;
    }
    
    /**
     * @param fieldIgnoreNulls The fieldIgnoreNulls to set.
     */
    public void setFieldIgnoreNulls(boolean[] fieldIgnoreNulls)
    {
        this.fieldIgnoreNulls = fieldIgnoreNulls;
    }
    ...
    /**
     * @return Returns the lastVersionField.
     */
    public String getLastVersionField()
    {
        return lastVersionField;
    }
    
    /**
     * @param lastVersionField The lastVersionField to set.
     */
    public void setLastVersionField(String lastVersionField)
    {
        this.lastVersionField = lastVersionField;
    }
	...
	public void allocate(int nrkeys, int nrfields)
	{
		...
		fieldIgnoreNulls = new boolean[nrfields];
	}
	...
	public final static boolean getIgnoreType(boolean upd, String ty)
	{
		if (upd)
		{
			if (ty.equalsIgnoreCase("Y")) {
				return true;
			} else return false; // false is the default: don't lose information.
		}
		else
		{
			return false;
	...
	public final static String getIgnoreType(boolean upd, boolean t)
	{
		if (!upd || !t)
			return "N";
		else 
	...
	public final static boolean isUpdateTypeWithoutArgument(boolean update, int type) {
		...
		case TYPE_UPDATE_DATE_SOURCE : return true;
  ...
  public String getXML() {
    ...
    if (fieldStream != null) {
      for (int i = 0; i < fieldStream.length; i++) {
          ...
          retval.append("          ").append(XMLHandler.addTagValue("ignorenulls", getIgnoreType(update, fieldIgnoreNulls[i]))); 
          retval.append("        </field>").append(Const.CR); 
      }
    }
    ...
    retval.append("          ").append(XMLHandler.addTagValue("lastversion", lastVersionField));
    retval.append("        </return>").append(Const.CR); 
    ...
    retval.append("      ").append(XMLHandler.addTagValue("sorted_input", sortedInput));
  ...
  private void readData(Node stepnode, List<? extends SharedObjectInterface> databases) throws KettleXMLException {
    try {
      ...
      for (int i = 0; i < nrfields; i++) {
        ...
        ignorenull = XMLHandler.getTagValue(fnode, "ignorenulls");
        fieldIgnoreNulls[i] = getIgnoreType(update, ignorenull);
      }
      ...
      autoIncrement = !"N".equalsIgnoreCase(XMLHandler.getTagValue(fields, "return", "use_autoinc"));   //$NON-NLS-3$
      versionField = XMLHandler.getTagValue(fields, "return", "version");  
      lastVersionField = XMLHandler.getTagValue(fields, "return", "lastversion");
      ...
      sortedInput = "Y".equalsIgnoreCase(XMLHandler.getTagValue(stepnode, "sorted_input")); 
  ...
  public void readRep(Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases) throws KettleException {
    try {
      ...
      for (int i = 0; i < nrfields; i++) {
        ...
        fieldIgnoreNulls[i] = getIgnoreType(update, rep.getStepAttributeString(id_step, i, "field_ignore_nulls"));
      }
      ...
      lastVersionField = rep.getStepAttributeString(id_step, "last_version_field");
      ...
      sortedInput = rep.getStepAttributeBoolean(id_step, "sorted_input"); 
  ...
  public void saveRep(Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step) throws KettleException {
    try {
      ...
      if (fieldStream != null)
        for (int i = 0; i < fieldStream.length; i++) {
          ...
          rep.saveStepAttribute(id_transformation, id_step, i, "field_ignore_nulls", getIgnoreType(update, fieldIgnoreNulls[i]));
        }
      ...
      rep.saveStepAttribute(id_transformation, id_step, "last_version_field", lastVersionField);
      ...
      rep.saveStepAttribute(id_transformation, id_step, "sorted_input", sortedInput); 
	...
	public void check(List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepMeta, RowMetaInterface prev, String input[], String output[], RowMetaInterface info, VariableSpace space, Repository repository, IMetaStore metaStore)
	{
		...
		if (input.length > 0)
		{
			CheckResult cr = new CheckResult(CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString(PKG, "DimensionLookupMeta.CheckResult.StepReceiveInfoOK"), 
					stepMeta);
			remarks.add(cr);
		}
		else
		{
			CheckResult cr = new CheckResult(CheckResultInterface.TYPE_RESULT_ERROR, BaseMessages.getString(PKG, "DimensionLookupMeta.CheckResult.NoInputReceiveFromOtherSteps"), 
					stepMeta);
			remarks.add(cr);
		}
	}
		...
		if (databaseMeta != null)
		{
			...
			try
			{
				...
				if (!Const.isEmpty(tableName))
				{
					...
					if (r != null)
					{
						for (int i = 0; i < fieldLookup.length; i++)
						{
							...
							logDebug(BaseMessages.getString(PKG, "DimensionLookupMeta.Log.CheckLookupField") + i + " --> " + lufield  
														+ " in lookup table..."); 
						...
						else
						{
							cr = new CheckResult(CheckResultInterface.TYPE_RESULT_OK,
									BaseMessages.getString(PKG, "DimensionLookupMeta.CheckResult.AllLookupFieldFound"), stepinfo); 
						}
						remarks.add(cr);
                        ...
                        if (keyField!=null && keyField.length()>0)
                        {
    						...
    						{
    							error_message = BaseMessages.getString(PKG, "DimensionLookupMeta.CheckResult.TechnicalKeyNotFound",keyField )  
    											+ Const.CR;
    							cr = new CheckResult(CheckResultInterface.TYPE_RESULT_ERROR, error_message, stepinfo);
    						}
    						else
    						{
    							error_message = BaseMessages.getString(PKG, "DimensionLookupMeta.CheckResult.TechnicalKeyFound",keyField )  
    											+ Const.CR;
                        ...
                        if (versionField != null && versionField.length() > 0)
						{
							...
							{
								error_message = BaseMessages.getString(PKG, "DimensionLookupMeta.CheckResult.VersionFieldNotFound", versionField 
												) + Const.CR; 
								cr = new CheckResult(CheckResultInterface.TYPE_RESULT_ERROR, error_message, stepinfo);
							}
							else
						...
						if (dateFrom != null && dateFrom.length() > 0)
						{
							...
							{
								error_message = BaseMessages.getString(PKG, "DimensionLookupMeta.CheckResult.StartPointOfDaterangeNotFound", dateFrom 
												) + Const.CR; 
								cr = new CheckResult(CheckResultInterface.TYPE_RESULT_ERROR, error_message, stepinfo);
							}
							else
							{
								error_message = BaseMessages.getString(PKG, "DimensionLookupMeta.CheckResult.StartPointOfDaterangeFound", dateFrom 
												) + Const.CR; 
								cr = new CheckResult(CheckResultInterface.TYPE_RESULT_OK, error_message, stepinfo);
							}
							remarks.add(cr);
						...
						if (dateTo != null && dateTo.length() > 0)
						{
							...
							{
								error_message = BaseMessages.getString(PKG, "DimensionLookupMeta.CheckResult.EndPointOfDaterangeNotFound", dateTo 
												) + Const.CR; 
								cr = new CheckResult(CheckResultInterface.TYPE_RESULT_ERROR, error_message, stepinfo);
							}
							else
							{
								error_message = BaseMessages.getString(PKG, "DimensionLookupMeta.CheckResult.EndPointOfDaterangeFound", dateTo 
												) + Const.CR; 
								cr = new CheckResult(CheckResultInterface.TYPE_RESULT_OK, error_message, stepinfo);
							}
							remarks.add(cr);
				...
				if (prev != null && prev.size() > 0)
				{
					...
					{
						cr = new CheckResult(CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString(PKG, "DimensionLookupMeta.CheckResult.AllFieldsFound"), 
								stepinfo);
					}
					remarks.add(cr);
				}
				...
				if (!Const.isEmpty(tableName))
				{
					...
					if (tableFields != null)
					{
						if (prev != null && prev.size() > 0)
						{
							...
							for (i = 0; i < keyStream.length; i++)
							{
								...
								else
								{
									...
									if (dimvalue == null)
									{
										...
										error_found = true;
										error_message += "\t\t" + dimfield +BaseMessages.getString(PKG, "DimensionLookupMeta.CheckResult.KeyNotPresentInDimensiontable")  
									...
									else
									{
										...
										if (strvalue.getType() != dimvalue.getType())
										{
											...
											error_message += "\t\t" + strfield + " (" + strvalue.getOrigin()  
																+BaseMessages.getString(PKG, "DimensionLookupMeta.CheckResult.KeyNotTheSameTypeAs") + dimfield + " ("  
																+ schemaTable + ")" + Const.CR; 
							...
							for (i = 0; i < fieldLookup.length; i++)
							{
								...
								if (lufield != null && lufield.length() > 0)
								{
									...
									if (v == null)
									{
										...
										{
											first = false;
											error_message += BaseMessages.getString(PKG, "DimensionLookupMeta.CheckResult.FieldsToRetrieveNotExistInDimension") 
																+ Const.CR;
										}
										error_found = true;
										error_message += "\t\t" + lufield + Const.CR; 
							...
							{
								cr = new CheckResult(CheckResultInterface.TYPE_RESULT_OK,
										BaseMessages.getString(PKG, "DimensionLookupMeta.CheckResult.AllFieldsToRetrieveFound"), stepinfo); 
							}
							remarks.add(cr);
							...
							{
								error_message = BaseMessages.getString(PKG, "DimensionLookupMeta.CheckResult.VersionFieldFound", versionField )  
												+ Const.CR;
								cr = new CheckResult(CheckResultInterface.TYPE_RESULT_OK, error_message, stepinfo);
							}
							remarks.add(cr);
							...
							{
								error_message = BaseMessages.getString(PKG, "DimensionLookupMeta.CheckResult.StartOfDaterangeFieldNotFound", dateFrom 
												) + Const.CR; 
								cr = new CheckResult(CheckResultInterface.TYPE_RESULT_ERROR, error_message, stepinfo);
							}
							else
							{
								error_message = BaseMessages.getString(PKG, "DimensionLookupMeta.CheckResult.StartOfDaterangeFieldFound", dateFrom 
												) + Const.CR; 
								cr = new CheckResult(CheckResultInterface.TYPE_RESULT_OK, error_message, stepinfo);
							}
							remarks.add(cr);
							...
							{
								error_message = BaseMessages.getString(PKG, "DimensionLookupMeta.CheckResult.EndOfDaterangeFieldNotFound", dateTo 
												) + Const.CR; 
								cr = new CheckResult(CheckResultInterface.TYPE_RESULT_ERROR, error_message, stepinfo);
							}
							else
	...
	public SQLStatement getSQLStatements(TransMeta transMeta, StepMeta stepMeta, RowMetaInterface prev, Repository repository, IMetaStore metaStore)
	{
		...
		if (update) // Only bother in case of update, not lookup!
		{
			...
			if (databaseMeta != null)
			{
				if (prev != null && prev.size() > 0)
				{
					...
					{                       
						...
						try
						{
							...
							// The last version
							ValueMetaInterface vlastversion = new ValueMeta(lastVersionField, ValueMetaInterface.TYPE_STRING);
							vlastversion.setLength(255);
							fields.addValueMeta(vlastversion);
				...
				{
					retval
							.setError(BaseMessages.getString(PKG, "DimensionLookupMeta.ReturnValue.NotReceivingAnyFields")); 
				}
			}
			else
			{
