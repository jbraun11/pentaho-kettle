...
public class DimensionLookupTest {
  ...
  public void testDimInsert() throws Exception {
    ...
    dimensionLookupSpy.dimInsert( objects, new Long("132323"), true, null, date, date, new Long("1231243") );
    verify( databaseMeta, times( 0 ) ).supportsAutoGeneratedKeys();

    dimensionLookupSpy.dimInsert( objects, null, true, null, date, date, new Long("1231243") );
